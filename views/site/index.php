...
<div class="site-index text-light">
    ...
    <div class=" text-center bg-transparent m-5 ">
        ...
        <p>
            ...
            <a class="btn btn-lg btn-outline-light " >Comenzar!</a></p>
    </div>

    <div class="container">

        <div class="cards-intro">
            <div class="shadow-lg card bg-transparent text-light border-end-0 border-start-0  border-white mx-1 p-4">
            ...
            <div class="shadow-lg card bg-transparent text-light border-end-0 border-start-0 border-white p-4">
